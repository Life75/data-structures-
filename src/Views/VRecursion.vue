    ...
    <div class=" mt-10 flex  gap-x-7">
        ...
        <div class="w-full shadow-md">
            <span class="flex flex-row justify-center items-center text-center  align-middle">
                <p class="text-2xl font-bold mr-auto ml-auto  text-neutral-200  ">{{ currentHeaderName }}</p>

                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    class="bi bi-gear-fill lg:hidden flex" viewBox="0 0 16 16"
                    @click="recursionSettingsDrawer = !recursionSettingsDrawer">
                    <path
        ...
        <el-drawer v-model="recursionSettingsDrawer" class="bg-base-100" size="100%" >
            <RecursionHeader @n="setN" @start="wasPressed"
